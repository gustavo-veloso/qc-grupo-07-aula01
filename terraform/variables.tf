/*
Adicionando a variável que receberá o IP que estará autorizado a connectar na VM através de SSH
*/

variable "meu_ip" {
  description = "IP publico autorizado para acessar SSH na VM"
  type        = string
}
